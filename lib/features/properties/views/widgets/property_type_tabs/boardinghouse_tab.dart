...
class BoardingHouseScreen extends StatelessWidget {
  const BoardingHouseScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // Make the app bar overlay the background image
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                     image: NetworkImage("https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      // Location Input
                      _buildSearchField(Icons.search, "Properties with city view in Bacolod..."),
                      ...
                      Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _buildQuickFilter(Icons.tune, "Filters"),
                              const SizedBox(width: 8),
                              _buildQuickFilter(null, "Air Conditioning"),
                              const SizedBox(width: 8),
                              _buildQuickFilter(null, "Free Wi-Fi"),
                              const SizedBox(width: 8),
                              _buildQuickFilter(null, "Private Bath"),
                            ],
                          ),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("We price match", style: TextStyle(color: Colors.grey[700], fontSize: 12)),
                          ],
                        ),
                      )
                    ],
  ...
  // Small pill-shaped filter buttons
  ...
  Widget _buildBenefitCard({required IconData icon, required String title, required String subtitle, required Color iconColor}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.pink.shade100, width: 1.5), // Matches the pink tint from your screenshot
        boxShadow: [
