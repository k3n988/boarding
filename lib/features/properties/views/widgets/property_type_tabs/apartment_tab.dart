            ...
            Stack(
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage("https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"), 
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _buildSearchField(Icons.search, "Find your perfect apartment..."),
                      Divider(height: 1, color: Colors.grey[300]),
                      _buildSearchField(Icons.calendar_month_outlined, "Sat, Feb 21 - Sun, Feb 22", trailingText: "1 month"),
                      Divider(height: 1, color: Colors.grey[300]),
                      _buildSearchField(Icons.person_outline, "1 room  •  2 adults"),
                      Divider(height: 1, color: Colors.grey[300]),
                      Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildBenefitCard(
                    ...
                    subtitle: "All our apartments are strictly vetted for your security.",
                  ...
                  _buildBenefitCard(
                    ...
                    subtitle: "We offer the most competitive apartment prices around Bacolod City.",
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(text, style: const TextStyle(fontSize: 15, color: Colors.black87), maxLines: 1, overflow: TextOverflow.ellipsis)),
          if (trailingText != null) Text(trailingText, style: TextStyle(fontSize: 13, color: Colors.grey[500])),
        ],
      ),
    );
  }
